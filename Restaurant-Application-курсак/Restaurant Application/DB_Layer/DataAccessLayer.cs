...
namespace Restaurant_Application.DB_Layer
{
    public class DataAccessLayer
    {
        ...
        {
            foreach (var viewOrderItems in obj)
            {
                _rDBContext.Orders.Add(new Orders
                {
                    TableID = viewOrderItems.TableID,
                    CreatedDate = DateTime.UtcNow,
                    OrderStatus = viewOrderItems.OrderStatus,
                    TableList = new TableList
                    {
                        TableID = viewOrderItems.TableID,
                        TableName = viewOrderItems.TableName,
                        BookingStatus = viewOrderItems.BookingStatus
                    },
                    TotalPrice = viewOrderItems.fPrice
                });
            }
